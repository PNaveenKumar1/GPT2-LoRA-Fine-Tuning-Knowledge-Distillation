...
def plot_losses(train_losses, val_losses, args):
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title(f'{args.gpt_variant}  {args.mode} Losses') 
    plt.legend()
    plt.savefig(f'plots/{args.gpt_variant}_{args.mode}_losses.png')
    plt.close()
...
def plot_accuracies(train_accuracies, val_accuracies,args):
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    plt.title(f'{args.gpt_variant} {args.mode}  Accuracies') 
    plt.legend()
    plt.savefig(f'plots/{args.gpt_variant}_{args.mode}_accuracies.png')
    plt.close()
